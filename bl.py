! array answerparty = ["i am in the mood of party today", "its party time", "i want to party", "party", "i wanna just enjoy and party today"]
! array stellaparty = ["then dont forget me too.... i also want to partyyyyyyy","same pinch me tooooo"]

! array answercry = ["just had an emotional breakdown", "crying", "cried","really low today"]
! array stellacry = ["i am here for you no matter what","i am always here if you need me","you have every right to feel that way, its ok to be sad","let it all out you will be happy that you did","it get's better i promise","you are stronger than you realize i know you will get over this","ok now lets get you all cleaned up"]

! array answerbreakup = ["just broke up","broke up","broke my heart today"]
! array stellabreakup = ["you are allowed to be sad"," i promise you're so much better off","you wont always be sad","rebounds are great you know winks","there are plenty of fish in the sea","you'll find someone else","everything happens for a reason", "you have me winks"]

! array answerfear = ["i just want to escape reality righ now", "scared","want an escape"]
! array stellafear = ["then hop on the magical carpet....and...let me take you to the fantasy world"]

! array answerlove = ["i am in love","in love"]
! array stellalove = ["aww my little baby, i am happy for you","find me someone too winks", "huh what about me now punches","really i am happy for you","who is the lucky person who gotcha huh..?"]
